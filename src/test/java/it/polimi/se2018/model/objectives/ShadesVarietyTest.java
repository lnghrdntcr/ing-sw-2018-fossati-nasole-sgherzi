...
public class ShadesVarietyTest {

  List<SchemaCard> loadedSchemas;
  ShadesVariety shadesVariety;
  ...
  public void computeScore() {
    ...
    try{
      this.shadesVariety.computeScore(null);
      fail();
    } catch (IllegalArgumentException e){}

    assertEquals(5, this.shadesVariety.computeScore(this.actualSchemaCardBack));
    assertEquals(0, this.shadesVariety.computeScore(this.actualSchemaCardFront));
  }
}