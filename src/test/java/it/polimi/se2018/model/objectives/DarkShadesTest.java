...
public class DarkShadesTest {
  ...
  public void computeScore() {
    ...
    try{
      this.darkShades.computeScore(null);
      fail();
    } catch (IllegalArgumentException e){}


    assertEquals(2, this.darkShades.computeScore(this.actualSchemaCardBack));
    assertEquals(2, this.darkShades.computeScore(this.actualSchemaCardFront));
  }
}