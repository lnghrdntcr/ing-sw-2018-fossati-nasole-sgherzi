...
public class ColorVarietyTest {
  ...
  public void computeScore() {
    ...
    try{
      this.colorVariety.computeScore(null);
      fail();
    } catch (IllegalArgumentException e){}

    assertEquals(4, this.colorVariety.computeScore(this.actualSchemaCardBack));
    assertEquals(0, this.colorVariety.computeScore(this.actualSchemaCardFront));
